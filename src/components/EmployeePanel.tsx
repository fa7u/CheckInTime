          ...
          <div className="bg-[#121214] rounded-2xl border border-[#27272A] p-6 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#1A1C1E] border border-blue-900/30 rounded-xl p-4 text-right space-y-3">
                ...
                <p className="text-[11px] text-[#8E8E93] leading-relaxed">
                  <strong>دعم حقيقي ودائم (حتى عند إغلاق التطبيق):</strong> نستخدم خوادم Google لتقديم إشعارات دفع فورية ومستقرة، تصل لهاتفك بشكل مباشر ودائم في أي وقت حتى لو كان المتصفح مغلقاً بالكامل.
                </p>
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0A0A0B] border border-[#27272A] text-xs px-2.5 py-1.5 rounded-lg text-white font-mono placeholder-[#52525B] focus:outline-none focus:border-blue-500"
                    />
                  </div>
